...
class MAGICDatasetLORAKS(Dataset):
    ...
    def __getitem__(self, ind):
        ...
        if self.X_JLORAKS is None:  # Open in thread
            ...
            self.X_JLORAKS = self.tables.root.X_JLORAKS_se
            self.Y_JLORAKS = self.tables.root.Y_JLORAKS_se
            self.Sens = self.tables.root.Sens_se
            self.X_kJLORAKS = self.tables.root.X_kJLORAKS_se
            self.mask = self.tables.root.mask_se
